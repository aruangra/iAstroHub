...
<html>
	...
	function load_FIT(filename) {
			
		xmlhttp = GetXmlHttpObject();
		var url = "INDI_loadimage.php?file=" + filename;
		xmlhttp.onreadystatechange = handleResponse;
		xmlhttp.open("GET",url,true);
		xmlhttp.send(null);
...
&nbsp;&nbsp;&nbsp;
<input type="button" value="Load FITS" onClick="javascript: load_FIT(document.getElementById('image').value);" style="background-color:#000000; color:#FF0000">		
&nbsp;&nbsp;&nbsp;
<input type="button" value="Load JPG" onClick="javascript: load(document.getElementById('image').value);" style="background-color:#000000; color:#FF0000">		
