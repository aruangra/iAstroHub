...
&nbsp;&nbsp;&nbsp;
<input type="button" value="Preview" onClick="javascript: vcurve(1,1,1,document.getElementById('exposure').value,document.getElementById('size').value);" style="background-color:#000000; color:#FF0000">
<p>
