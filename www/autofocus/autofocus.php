...
<input type="button" value="Select" onClick="javascript: select_star(document.getElementById('size').value);" style="background-color:#000000; color:#FF0000">
<input type="button" value="Reset" onClick="javascript: reset();" style="background-color:#000000; color:#FF0000">
&nbsp;&nbsp;&nbsp;
<input type="button" value="View" onClick="javascript: vcurve(1,1,1,document.getElementById('exposure').value,64);" style="background-color:#000000; color:#FF0000">
<p>

#Points
<input type="text" size="3" value="" name="point" id="point" style="background-color:#302217; color:#FF0000"/>
<input type="button" value="Generate V-Curve" onClick="javascript: vcurve(document.getElementById('point').value,document.getElementById('move').value,document.getElementById('dir').value,document.getElementById('exposure').value,64);" style="background-color:#000000; color:#FF0000">
&nbsp;&nbsp;&nbsp;
