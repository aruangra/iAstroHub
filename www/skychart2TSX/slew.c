...
int main()
{
	...
	sprintf(cmd,"/* Java Script */var TargetRA = \"%.6f\";var TargetDec = \"%.6f\";var Out;sky6RASCOMTele.Connect();if (sky6RASCOMTele.IsConnected==0) {Out = \"Not connected\"} else {sky6RASCOMTele.Asynchronous = true;sky6RASCOMTele.SlewToRaDec(TargetRA, TargetDec,\"\");Out = \"OK\";}//_",ra,dec);
